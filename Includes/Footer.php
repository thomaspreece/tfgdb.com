...
<div style='z-index:2;background-image: url(".$DOMAIN."/Resources/BackGrad2.png);opacity:0.95;filter:alpha(opacity=95); background-color: #3f3f59; position:absolute; left:0px; bottom:0px; width:100%; height:25px;' >
	<div style='width:992px;height:25px;margin-left:auto;margin-right:auto;color: white;'>
		...
		<div style='float: right;margin-right:15px; padding:5px;'><a class='FooterLink' href='".$DOMAIN."/AboutUs.php'>About Us</a></div>
	</div>
</div>
...
try {Histats.start(1,2420683,4,0,0,0,"");
Histats.track_hits();} catch(err){};
</script></a>
<noscript><a href="http://www.histats.com" target="_blank"><img  src="http://sstatic1.histats.com/0.gif?2420683&101" alt="counter easy hit" border="0"></a></noscript>
<!-- Histats.com  END  -->
...
<script>
  ...
  ga('create', 'UA-39629967-2', 'tfgdb.com');
  ga('send', 'pageview');
